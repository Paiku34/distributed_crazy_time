...
\begin{figure}[H]
    \centering
    \IfFileExists{wheel.png}{\includegraphics[width=0.7\textwidth]{wheel.png}}{\rule{0.7\textwidth}{5cm}}
\end{figure}
...
\begin{figure}[H]
    \centering
    \IfFileExists{nodes.png}{\includegraphics[width=0.8\textwidth]{nodes.png}}{\rule{0.8\textwidth}{5cm}}
\end{figure}
...
\begin{itemize}
    \item \textbf{VM1 (10.2.1.17)}: Hosts RabbitMQ Server, Java Gateway, and Erlang nodes game1 and game2 (representing majority quorum of 2/3).
    \item \textbf{VM2 (10.2.1.18)}: Hosts Erlang node game3 (Active Leader / Primary Dealer).
\end{itemize}
