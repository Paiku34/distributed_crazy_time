...
# Indirizzo del server (modifica qui o passa da riga di comando, es: python stress_test.py http://10.2.1.15:8080)
...
if __name__ == "__main__":
    ...
    if logged_in_count == 0:
        ...
        print(f"Esempio d'uso: python stress_test.py http://10.2.1.15:8080 oppure http://localhost:8080")
        sys.exit(1)
